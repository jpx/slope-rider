...
public class ComponentFactory {
    ...
    public ComponentFactory(final Stage stage, final AssetManager assetManager, final PhysicsWorld physicsWorld) {
        ...
        _components = new ArrayList<Map.Entry<Component, Layer>>();
        _componentsToAdd = new ArrayList<Map.Entry<Component, Layer>>();
    ...
    public final void ready() {
        ...
        for (final Map.Entry<Component, Layer> component : _componentsToAdd) {
            _components.add(new AbstractMap.SimpleEntry<>(component.getKey(), component.getValue()));
        }
    ...
    public final <T extends Component> T destroyComponent(final T component) {
        final Map.Entry<Component, Layer> entry = _components.stream().filter(e -> e.getKey() == component).findFirst().orElse(null);
